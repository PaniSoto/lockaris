  ...
  return (
    <div className="flex h-screen bg-gray-100 font-sans">
      <aside className="w-64 bg-slate-900 text-white flex flex-col shadow-xl">
        ...
        <nav className="flex-1 px-4 py-6 space-y-2">
          ...
          <div className="pt-6">
            ...
            <Link
              ...
              className={getLinkStyle("/tools/generator")}
            >
        ...
        <div
          className="p-4 border-t border-slate-800 bg-slate-900 relative"
          ref={menuRef}
        >
          {isUserMenuOpen && (
          ...
          >
            {/* Se muestra el nombre y correo del perfil sincronizado */}
