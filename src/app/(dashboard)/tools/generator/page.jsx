  ...
  return (
    <div className="p-8 max-w-6xl mx-auto min-h-screen bg-gray-50/50">
      ...
      <div className="max-w-2xl mx-auto">
        {/* SECCIÓN RESULTADO: Estilo "Display" */}
        ...
        {/* SECCIÓN CONFIGURACIÓN: Estilo "Controles" */}
          ...
          <div className="space-y-8">
            ...
            <div>
              <div className="flex justify-between items-center mb-6">
                <label className="text-sm font-bold text-gray-500 uppercase tracking-wider">Longitud de clave</label>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
              {Object.keys(options).map((opt) => (
                ...
                >
                  <span className={`text-sm font-bold ${options[opt] ? "text-blue-900" : "text-gray-500"}`}>
                    {opt === "uppercase" ? "Mayúsculas" : opt === "lowercase" ? "Minúsculas" : opt === "numbers" ? "Números" : "Símbolos"}
                  </span>
                  <div className={`w-6 h-6 rounded-full border-2 flex items-center justify-center ${
                    options[opt] ? "bg-blue-600 border-blue-600" : "border-gray-300"
                  }`}>
